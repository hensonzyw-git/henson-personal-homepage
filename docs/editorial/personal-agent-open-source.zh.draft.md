...
我也计划同时在 Muse 上把自己所有的工具逐一搭建起来，让两边面对同样的个人需求。在实际使用中，我想比较工具搭建的过程、任务完成的效果，以及哪些地方仍然需要我介入。自己的系统会继续做，Muse 也会继续深入用；这种对照本身，也是我理解 Agent 的一种方式。
...
接下来，我会优先补 Memory。这是我对当前产品阶段的一个判断：**Memory 是让这个 Agent 从“能用”走向“好用”的升级，DAL 则主要提升工具开发的效率。**
...
DAL 仍然值得继续做，它能帮助我更高效地开发和维护工具。但工具开发得更快，不会自动让 Agent 更理解我。对这个阶段的 Personal Agent 来说，DAL 带来的是提效，Memory 才是我期待的体验质变。因此，我把 Memory 放在更前面。
